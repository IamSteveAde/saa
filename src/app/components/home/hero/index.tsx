  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-[#0a0a0a] text-white">
      ...
      */}
      ...
      {/* ── HERO CONTENT ──
          The key fix: pt-36 on mobile (144px) pushes content well below the
          navbar + the mission line above. pb-36 leaves room for the marquee.
          On desktop: items-center vertically centres as before, pb-0.
      ── */}
      <div className="relative z-10 flex h-full flex-col justify-center px-6 pt-36 pb-36 md:px-24 md:pt-0 md:pb-0">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* HEADLINE */}
            <h1 className="text-[2.4rem] font-medium leading-[1.07] tracking-tight md:text-[4rem]">
            ...
            {/* DESCRIPTION */}
            <p
              className="mt-5 max-w-md text-sm font-light leading-relaxed md:mt-6 md:text-lg"
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4 md:mt-10 md:gap-5">
              ...
              <Link
                href="/contact"
                className="group relative inline-flex items-center gap-3 overflow-hidden rounded-full px-6 py-3 text-sm font-medium tracking-wide transition-all duration-300 md:px-7 md:py-3.5"
            ...
            {/* TAGLINE */}
            <p
              className="mt-8 text-[10px] font-medium uppercase tracking-[0.22em] md:mt-10"
      ...
      <div className="absolute bottom-20 right-5 z-20 flex items-center gap-3 md:bottom-32 md:right-10">
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full border text-sm transition-all duration-200 md:h-10 md:w-10"
          style={{
          ...
          >
            {[...logos, ...logos].map((logo, i) => (
              <Image
                ...
                height={40}
                priority={i < 6}
                className="h-4 w-auto brightness-0 invert grayscale transition-opacity duration-300 md:h-6"
                style={{ opacity: 0.38 }}
                onMouseEnter={(e) =>
                  ((e.currentTarget as HTMLImageElement).style.opacity = "0.65")
                }
                onMouseLeave={(e) =>
                  ((e.currentTarget as HTMLImageElement).style.opacity = "0.38")
                }
              />
            ))}
          </div>
